...
const NotFound = () => {
  return (
    <div className="center max-w-md text-center">
      ...
      <p className="text-gray-500">Sorry, the resource you were looking for was not found, or you don't have access to view it. You could still visit <Link to="/" className="underline">Home</Link></p>
    </div>
  );
};
